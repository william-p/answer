...
import (
	...
	webhook2 "github.com/apache/answer/internal/service/webhook"
...
func initApplication(debug bool, serverConf *conf.Server, dbConf *data.Database, cacheConf *data.CacheConf, i18nConf *translator.I18n, swaggerConf *router.SwaggerConfig, serviceConf *service_config.ServiceConfig, uiConf *server.UI, logConf log.Logger) (*pacman.Application, func(), error) {
	...
	reviewService := review2.NewReviewService(reviewRepo, objService, userCommon, userRepo, questionRepo, answerRepo, userRoleRelService, externalService, tagCommonService, questionCommon, noticequeueService, siteInfoCommonService, commentCommonRepo, eventqueueService)
	...
	userAdminService := user_admin.NewUserAdminService(userAdminRepo, userRoleRelService, authService, userCommon, userActiveActivityRepo, siteInfoCommonService, emailService, questionRepo, answerRepo, commentCommonRepo, userExternalLoginRepo, notificationRepo, pluginUserConfigRepo, badgeAwardRepo, eventqueueService)
	...
	webhookService := webhook2.NewWebhookService()
	webhookEventHandler := webhook2.NewWebhookEventHandler(webhookRepo, webhookService, eventqueueService)
	application := newApplication(serverConf, ginEngine, scheduledTaskManager, webhookEventHandler)
